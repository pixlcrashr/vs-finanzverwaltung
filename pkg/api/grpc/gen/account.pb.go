...
const file_account_proto_rawDesc = "" +
	"\n" +
	"\raccount.proto\x12\x12pixlcrashr.vsfv.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x93\x04\n" +
	"\aAccount\x12\x17\n" +
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x03R\x04name\x12\x15\n" +
	"\x03uid\x18\x02 \x01(\tB\x03\xe0A\x03R\x03uid\x12J\n" +
	...
	"createTime:4\xeaA1\n" +
	"\x1bvsfv.pixlcrashr.dev/Account\x12\x12accounts/{account}\"\xa7\x04\n" +
	...
	"\x1bvsfv.pixlcrashr.dev/AccountR\x04name\"\xc0\x01\n" +
	...
	"\fshow_deleted\x18\x04 \x01(\bB\x03\xe0A\x01R\vshowDeleted\x12\x1e\n" +
	...
	"\n" +
	"total_size\x18\x03 \x01(\x03R\ttotalSize\"R\n" +
	"\x14CreateAccountRequest\x12:\n" +
	"\aaccount\x18\x01 \x01(\v2\x1b.pixlcrashr.vsfv.v1.AccountB\x03\xe0A\x02R\aaccount\"\x94\x01\n" +
	...
	"\x04name\x18\x01 \x01(\tB#\xe0A\x02\xfaA\x1d\n" +
	"\x1bvsfv.pixlcrashr.dev/AccountR\x04name\"8\n" +
	"\x19ListNestedAccountsRequest\x12\x1b\n" +
	"\x06filter\x18\x01 \x01(\tB\x03\xe0A\x01R\x06filter\"[\n" +
	...
	"\aaccount\x18\x01 \x01(\v2!.pixlcrashr.vsfv.v1.NestedAccountR\aaccount2\xf5\b\n" +
	"\x0eAccountService\x12v\n" +
	"\n" +
	"GetAccount\x12%.pixlcrashr.vsfv.v1.GetAccountRequest\x1a\x1b.pixlcrashr.vsfv.v1.Account\"$\xdaA\x04name\x82\xd3\xe4\x93\x02\x17\x12\x15/v1/{name=accounts/*}\x12w\n" +
	"\fListAccounts\x12'.pixlcrashr.vsfv.v1.ListAccountsRequest\x1a(.pixlcrashr.vsfv.v1.ListAccountsResponse\"\x14\x82\xd3\xe4\x93\x02\x0e\x12\f/v1/accounts\x12\x94\x01\n" +
	"\x12ListNestedAccounts\x12-.pixlcrashr.vsfv.v1.ListNestedAccountsRequest\x1a..pixlcrashr.vsfv.v1.ListNestedAccountsResponse\"\x1f\x82\xd3\xe4\x93\x02\x19\x12\x17/v1/accounts:listNested\x12\x9d\x01\n" +
	"\x10GetNestedAccount\x12+.pixlcrashr.vsfv.v1.GetNestedAccountRequest\x1a,.pixlcrashr.vsfv.v1.GetNestedAccountResponse\".\xdaA\x04name\x82\xd3\xe4\x93\x02!\x12\x1f/v1/{name=accounts/*}:getNested\x12\x7f\n" +
	"\rCreateAccount\x12(.pixlcrashr.vsfv.v1.CreateAccountRequest\x1a\x1b.pixlcrashr.vsfv.v1.Account\"'\xdaA\aaccount\x82\xd3\xe4\x93\x02\x17:\aaccount\"\f/v1/accounts\x12\x9c\x01\n" +
	"\rUpdateAccount\x12(.pixlcrashr.vsfv.v1.UpdateAccountRequest\x1a\x1b.pixlcrashr.vsfv.v1.Account\"D\xdaA\x13account,update_mask\x82\xd3\xe4\x93\x02(:\aaccount2\x1d/v1/{account.name=accounts/*}\x12\x89\x01\n" +
	"\x0eArchiveAccount\x12).pixlcrashr.vsfv.v1.ArchiveAccountRequest\x1a\x1b.pixlcrashr.vsfv.v1.Account\"/\xdaA\x04name\x82\xd3\xe4\x93\x02\":\x01*\"\x1d/v1/{name=accounts/*}:archive\x12w\n" +
	"\rDeleteAccount\x12(.pixlcrashr.vsfv.v1.DeleteAccountRequest\x1a\x16.google.protobuf.Empty\"$\xdaA\x04name\x82\xd3\xe4\x93\x02\x17*\x15/v1/{name=accounts/*}\x1a\x16\xcaA\x13vsfv.pixlcrashr.devBFZ+github.com/pixlcrashr/vsfv/pkg/api/grpc/gen\xaa\x02\x16Pixlcrashr.Vsfv.Sdk.V1b\x06proto3"
