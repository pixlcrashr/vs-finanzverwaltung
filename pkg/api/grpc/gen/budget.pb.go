...
const file_budget_proto_rawDesc = "" +
	"\n" +
	"\fbudget.proto\x12\x12pixlcrashr.vsfv.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x16google/type/date.proto\"\xe1\x03\n" +
	"\x06Budget\x12\x17\n" +
	...
	"createTime:1\xeaA.\n" +
	"\x1avsfv.pixlcrashr.dev/Budget\x12\x10budgets/{budget}\"J\n" +
	"\x10GetBudgetRequest\x126\n" +
	"\x04name\x18\x01 \x01(\tB\"\xe0A\x02\xfaA\x1c\n" +
	"\x1avsfv.pixlcrashr.dev/BudgetR\x04name\"\xbf\x01\n" +
	...
	"\x13CreateBudgetRequest\x127\n" +
	"\x06budget\x18\x01 \x01(\v2\x1a.pixlcrashr.vsfv.v1.BudgetB\x03\xe0A\x02R\x06budget\"\x90\x01\n" +
	...
	"\x04name\x18\x01 \x01(\tB\"\xe0A\x02\xfaA\x1c\n" +
	"\x1avsfv.pixlcrashr.dev/BudgetR\x04name2\x9a\x06\n" +
	"\rBudgetService\x12r\n" +
	"\tGetBudget\x12$.pixlcrashr.vsfv.v1.GetBudgetRequest\x1a\x1a.pixlcrashr.vsfv.v1.Budget\"#\xdaA\x04name\x82\xd3\xe4\x93\x02\x16\x12\x14/v1/{name=budgets/*}\x12s\n" +
	"\vListBudgets\x12&.pixlcrashr.vsfv.v1.ListBudgetsRequest\x1a'.pixlcrashr.vsfv.v1.ListBudgetsResponse\"\x13\x82\xd3\xe4\x93\x02\r\x12\v/v1/budgets\x12y\n" +
	"\fCreateBudget\x12'.pixlcrashr.vsfv.v1.CreateBudgetRequest\x1a\x1a.pixlcrashr.vsfv.v1.Budget\"$\xdaA\x06budget\x82\xd3\xe4\x93\x02\x15:\x06budget\"\v/v1/budgets\x12\x95\x01\n" +
	"\fUpdateBudget\x12'.pixlcrashr.vsfv.v1.UpdateBudgetRequest\x1a\x1a.pixlcrashr.vsfv.v1.Budget\"@\xdaA\x12budget,update_mask\x82\xd3\xe4\x93\x02%:\x06budget2\x1b/v1/{budget.name=budgets/*}\x12\x7f\n" +
	"\vCloseBudget\x12&.pixlcrashr.vsfv.v1.CloseBudgetRequest\x1a\x1a.pixlcrashr.vsfv.v1.Budget\",\xdaA\x04name\x82\xd3\xe4\x93\x02\x1f:\x01*\"\x1a/v1/{name=budgets/*}:close\x12t\n" +
	"\fDeleteBudget\x12'.pixlcrashr.vsfv.v1.DeleteBudgetRequest\x1a\x16.google.protobuf.Empty\"#\xdaA\x04name\x82\xd3\xe4\x93\x02\x16*\x14/v1/{name=budgets/*}\x1a\x16\xcaA\x13vsfv.pixlcrashr.devBFZ+github.com/pixlcrashr/vsfv/pkg/api/grpc/gen\xaa\x02\x16Pixlcrashr.Vsfv.Sdk.V1b\x06proto3"
...
var file_budget_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
