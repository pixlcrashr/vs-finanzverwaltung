...
// (GET /v1/reports/{reportId}:download) and is intentionally excluded here.
type Report struct {
...
const file_report_proto_rawDesc = "" +
	"\n" +
	"\freport.proto\x12\x12pixlcrashr.vsfv.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x88\x02\n" +
	"\x06Report\x12\x17\n" +
	...
	"createTime:1\xeaA.\n" +
	"\x1avsfv.pixlcrashr.dev/Report\x12\x10reports/{report}\"J\n" +
	"\x10GetReportRequest\x126\n" +
	"\x04name\x18\x01 \x01(\tB\"\xe0A\x02\xfaA\x1c\n" +
	"\x1avsfv.pixlcrashr.dev/ReportR\x04name\"\x97\x01\n" +
	...
	"\border_by\x18\x04 \x01(\tB\x03\xe0A\x01R\aorderBy\"\x92\x01\n" +
	...
	"\x13CreateReportRequest\x127\n" +
	"\x06report\x18\x01 \x01(\v2\x1a.pixlcrashr.vsfv.v1.ReportB\x03\xe0A\x02R\x06report\"M\n" +
	"\x13DeleteReportRequest\x126\n" +
	"\x04name\x18\x01 \x01(\tB\"\xe0A\x02\xfaA\x1c\n" +
	"\x1avsfv.pixlcrashr.dev/ReportR\x04name2\x81\x04\n" +
	"\rReportService\x12r\n" +
	"\tGetReport\x12$.pixlcrashr.vsfv.v1.GetReportRequest\x1a\x1a.pixlcrashr.vsfv.v1.Report\"#\xdaA\x04name\x82\xd3\xe4\x93\x02\x16\x12\x14/v1/{name=reports/*}\x12s\n" +
	"\vListReports\x12&.pixlcrashr.vsfv.v1.ListReportsRequest\x1a'.pixlcrashr.vsfv.v1.ListReportsResponse\"\x13\x82\xd3\xe4\x93\x02\r\x12\v/v1/reports\x12y\n" +
	"\fCreateReport\x12'.pixlcrashr.vsfv.v1.CreateReportRequest\x1a\x1a.pixlcrashr.vsfv.v1.Report\"$\xdaA\x06report\x82\xd3\xe4\x93\x02\x15:\x06report\"\v/v1/reports\x12t\n" +
	"\fDeleteReport\x12'.pixlcrashr.vsfv.v1.DeleteReportRequest\x1a\x16.google.protobuf.Empty\"#\xdaA\x04name\x82\xd3\xe4\x93\x02\x16*\x14/v1/{name=reports/*}\x1a\x16\xcaA\x13vsfv.pixlcrashr.devBFZ+github.com/pixlcrashr/vsfv/pkg/api/grpc/gen\xaa\x02\x16Pixlcrashr.Vsfv.Sdk.V1b\x06proto3"
