...
func newSetting(db *gorm.DB, opts ...gen.DOOption) setting {
	...
	_setting.ValueFloat = field.NewFloat64(tableName, "value_float")
	_setting.ValueInt = field.NewInt64(tableName, "value_int")
	_setting.ValueText = field.NewString(tableName, "value_text")
	_setting.ValueBool = field.NewBool(tableName, "value_bool")
	_setting.ValueDecimal = field.NewField(tableName, "value_decimal")
	_setting.ValueUUID = field.NewField(tableName, "value_uuid")
...
type setting struct {
	...
	ID           field.String
	Type         field.String
	ValueFloat   field.Float64
	ValueInt     field.Int64
	ValueText    field.String
	ValueBool    field.Bool
	ValueDecimal field.Field
	ValueUUID    field.Field
...
func (s *setting) updateTableName(table string) *setting {
	...
	s.ValueFloat = field.NewFloat64(table, "value_float")
	s.ValueInt = field.NewInt64(table, "value_int")
	s.ValueText = field.NewString(table, "value_text")
	s.ValueBool = field.NewBool(table, "value_bool")
	s.ValueDecimal = field.NewField(table, "value_decimal")
	s.ValueUUID = field.NewField(table, "value_uuid")
...
func (s *setting) fillFieldMap() {
	...
	s.fieldMap["value_float"] = s.ValueFloat
	s.fieldMap["value_int"] = s.ValueInt
	s.fieldMap["value_text"] = s.ValueText
	s.fieldMap["value_bool"] = s.ValueBool
	s.fieldMap["value_decimal"] = s.ValueDecimal
	s.fieldMap["value_uuid"] = s.ValueUUID
