...
type LedgerYear struct {
	...
	OrganizationID uuid.UUID `gorm:"type:uuid;not null;uniqueIndex:idx_ledger_years_org_id,priority:2;uniqueIndex:idx_ledger_years_custom_id,priority:2"`
	Year       int       `gorm:"not null;default:0;uniqueIndex:idx_ledger_years_org_year"`
