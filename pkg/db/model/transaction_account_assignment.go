...
type TransactionAccountAssignment struct {
	...
	CustomID       string      `gorm:"uniqueIndex:idx_transaction_account_assignments_custom_id,priority:1"`
	OrganizationID uuid.UUID   `gorm:"type:uuid;not null;uniqueIndex:idx_transaction_account_assignments_org_id,priority:2;uniqueIndex:idx_transaction_account_assignments_org_trans_account,priority:1;uniqueIndex:idx_transaction_account_assignments_custom_id,priority:2"`
	TransactionID  uuid.UUID   `gorm:"type:uuid;not null;uniqueIndex:idx_transaction_account_assignments_org_trans_account,priority:2;uniqueIndex:idx_transaction_account_assignments_custom_id,priority:3"`
