...
export abstract class TransactionEditDataService {
  ...
  abstract updateAssignment(organizationId: string, transactionId: string, assignmentId: string, params: UpdateAssignmentParams): Observable<TransactionAssignment>;
